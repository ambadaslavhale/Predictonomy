      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-10 col-xs-10">
            <h1 class="logo"> <a href="index.php"><img src="images/Predictonomy Logo Official v0.3.png" alt="Logo">Predicting the economy through Artificial Intelligence</a></h1>
          </div>
          <!-- <div class="col-xs-7">
